...
public class Email {
	...
	public Email(String Email, String destinatario, String remetente,
		...
		try { 
			    ...
			    builder.append("<a href='http://www.desagil.com.br:8080/Cadastro/confirma-cadastro?token="+usuario.getToken()+"'>Clique aqui para confirmar seu cadastramento</a> <br> ");
			    builder.append("<p><br>Se você não solicitou o cadastramento, clique no link abaixo para nos informar :</p>");
			    builder.append("<a href='#'>Clique aqui para informar um cadastramento indevido</a> <br> ");
